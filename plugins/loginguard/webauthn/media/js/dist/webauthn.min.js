...
document.forms["loginguard-method-edit"].submit()},function(a){akeeba.LoginGuard.webauthn.handle_error(a)})}else alert(Joomla.JText._("PLG_LOGINGUARD_WEBAUTHN_ERR_NOTAVAILABLE_HEAD")),console.log("This browser does not support Webauthn")};akeeba.LoginGuard.webauthn.handle_error=function(b){alert(b);console.log(b)};
