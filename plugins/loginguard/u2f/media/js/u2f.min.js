var akeeba=akeeba||{};akeeba.LoginGuard=akeeba.LoginGuard||{};akeeba.LoginGuard.u2f=akeeba.LoginGuard.u2f||{regData:null,authData:null,handlingError:!1};akeeba.LoginGuard.u2f.setUp=function(){var a=akeeba.LoginGuard.u2f.regData[0];u2f.register(a.appId,[a],akeeba.LoginGuard.u2f.regData[1],akeeba.LoginGuard.u2f.setUpCallback)};
...
break}alert(Joomla.JText._("PLG_LOGINGUARD_U2F_ERR_JS_INELIGIBLE"));break;case 5:alert(Joomla.JText._("PLG_LOGINGUARD_U2F_ERR_JS_TIMEOUT"))}try{$("#loginguard-u2f-button").show()}catch(b){}akeeba.LoginGuard.u2f.handlingError=!1}};akeeba.LoginGuard.u2f.validate=function(){u2f.sign(akeeba.LoginGuard.u2f.authData[0].appId,akeeba.LoginGuard.u2f.authData[0].challenge,akeeba.LoginGuard.u2f.authData,akeeba.LoginGuard.u2f.validateCallback)};
